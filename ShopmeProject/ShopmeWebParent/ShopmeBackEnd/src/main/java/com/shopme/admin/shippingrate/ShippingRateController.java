...
public class ShippingRateController {
	...
	private String defaultRedirectURL = "redirect:/shipping_rates/pages/1?sortField=country&sortDir=asc";
	...
	@GetMapping("/shipping_rates/pages/{pageNum}")
	...
	public String saveRate(ShippingRate shippingRate,
