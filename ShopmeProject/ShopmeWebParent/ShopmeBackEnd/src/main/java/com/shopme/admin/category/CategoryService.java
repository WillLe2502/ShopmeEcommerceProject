...
import com.shopme.admin.category.controller.CategoryPageInfo;
...
public class CategoryService {
	...
	private List<Category> listHierarchicalCategories(List<Category> rootCategories, String sortDir) {
		...
		for(Category rootCategory : rootCategories) {
			...
			for(Category subCategory : children) {
				...
				listSubHierarchecalCategories(hierarchicalCategories, subCategory, 1, sortDir);
			}
		}
	...
	private void listSubHierarchecalCategories(List<Category> hierarchicalCategories,
											   Category parent, 
											   Integer subLevel,
											   String sortDir) {
		...
		for(Category subCategory : children) {
			...
			listSubHierarchecalCategories(hierarchicalCategories, subCategory, newSubLevel, sortDir);
		}
	}
	...
	private void listSubCategoryUsedInForm(List<Category> categoriesUsedInForm, 
							  Category parent,
							  int subLevel) {
		int newSubLevel = subLevel + 1;
